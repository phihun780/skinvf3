...
3. Xuất Hình ảnh SkinVF3. ✅ (dọc A4 300dpi 2480×3508 PNG + bản nhẹ JPG, ghép bằng canvas 2D ở `src/poster/renderPoster.ts`; ảnh 3/4 trước + 4 góc chụp riêng nền trong suốt; ảnh 3/4 lớn + lưới 2×2 bốn góc; góc phải chỉ ghi ngày tạo; chân trang ghi skinvf3.pages.dev (mờ) + ghi công mô hình 3D; không có bảng màu, mã thiết kế, decal; cửa sổ xem trước gắn vào <body> (nằm trên thanh trên, nền tối đặc); màu nền ở `src/config/poster.ts`)
