...
- **Dock điện thoại** (`src/ui/MobileDock.tsx`, thay bảng màu góc phải + bảng decal + thanh công cụ nổi): 1 tấm dính đáy màn hình, dưới cùng là hàng công cụ (Hoàn tác · Làm lại · Tự xoay · Reset · Lưu · Tải hình).
  - Màu sơn: dải tên vùng vuốt ngang (chạm tên = chọn vùng, vùng loé sáng; tên ngắn ở `SHORT_NAMES` trong `src/config/zones.ts`); chọn vùng rồi thì hiện dải ô màu 44px + ô màu tuỳ chọn, Bóng/Nhám, "Giống thân xe".
